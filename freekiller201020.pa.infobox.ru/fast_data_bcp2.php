					...
					<table>
						<thead>
							<tr class="row100 head">
								...
								<th class="cell100 column4"> Атакует / Город</th>
								<th class="cell100 column5"> Защищается / Город</th>
...
foreach ($attacks as $attack) {
    ...
    // foreach ($players2 as $pl2) {
        ...
        echo "<td class=\"cell100 column4\">{$name1} / {$attack[0]}</td>";
        echo "<td class=\"cell100 column5\">{$name2} / {$attack[1]}</td>";
